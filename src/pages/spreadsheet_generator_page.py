...
class SpreadsheetGenerator(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        funding_string_button = ctk.CTkButton(self, text="Funding String", command=lambda: controller.show_frame("FinancialMenu"))
        funding_string_button.pack(pady=10)


        program_effort_button = ctk.CTkButton(self, text="Program Effort", command=lambda: controller.show_frame("FinancialMenu"))
